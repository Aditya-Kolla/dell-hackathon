    ...
    render() {
        ...
        if (contactAddresses.length == 0) {
            ...
            for (var i=0;i<contactAddresses.length;i++) {
                ...
                // TODO: Check if the user is self then update the code 
                ...
                contactItems.push(
                    ...
                    <div class="chat_list active_chat chat_people">
                        <div class="chat_img"> <img src={user.avatarUrl ? user.avatarUrl : 'static/images/user.png'}/> </div>
                        <div class="chat_ib">
                        <h5>{user.name ? user.name : address.substr(0, 10)}</h5>
                    <p>{address.substr(0,14) + '...'}</p>
                    </div>
                         {rightAlignedContent} 
                    </div>
                    </List.Item>
        ...
        return (
            ...
            <div class="inbox_people">
                <div class="headind_srch">
                    <div class="recent_heading"><h4>Contact List</h4></div>
                    <Button color='blue' style={{float: 'right'}} onClick={this.addContactClicked}><Icon name='add user'></Icon>Add</Button>
                </div>
