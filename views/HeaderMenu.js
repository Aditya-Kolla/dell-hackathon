            ...
            if (this.state.isLoading == false) {
                if (this.state.address) {
                    ...
                    if (this.account.isJoined) {
                        ...
                        memberInfo = (
                            <Button color='blue' onClick={this.handleJoinClicked} 
                    ...
                    accountInfo = (
                        <Menu.Menu position='right'>
                            ...
                            <Menu.Item>
                                ...
                                <List.Item>
                                    Balance: <Label as='a' href={addressExplorerUrl} target='_blank' color='blue'>{parseFloat(web3.utils.fromWei("" +this.state.balance, 'ether')).toFixed(8) + ' ETH' }</Label>
                                    {pendingTxItem}
                                </List.Item>
                                </List>
                            </Menu.Item>
